...
//     version 1.17.0
//     from Assets/Menus.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Menus.inputactions".
/// </summary>
/// <remarks>
...
public partial class @Menus: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""menu"",
            ""id"": ""9451c5fa-9f57-46a6-bc01-75e867fcb3b7"",
            ""actions"": [
                {
                    ""name"": ""Pause"",
                    ""type"": ""Button"",
                    ""id"": ""fe71f9fd-c744-4b55-afd0-38f3da4f8e08"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""a6eef9fd-ba94-4c13-a0fc-924aaf55fd41"",
                ...
                {
                    ""name"": """",
                    ""id"": ""fcfc0f84-f6b2-487b-901a-38b6679cdd04"",
    ...
    ~@Menus()
    {
        UnityEngine.Debug.Assert(!m_menu.enabled, "This will cause a leak and performance issues, Menus.menu.Disable() has not been called.");
    }
    ...
    public struct MenuActions
    {
        ...
        /// </summary>
        public MenuActions(@Menus wrapper) { m_Wrapper = wrapper; }
        /// <summary>
